...
class AJArt_Gui:
    def __init__(self):
        ...
        ds_dict = {2: "Tiny", 10: "Small", 20:"Medium", 30:"Large", 40:"Very Large", 60:"Gigantic"}
        ...
        ###LOAD BUTTON###
        load_button = Button(self.win, text="Load", width=20, height=5, command=self.load)
        load_button.pack()
    ...
    def thanks(self):
        while self.p.done is False:
            time.sleep(1)
        result = tkinter.messagebox.askquestion("Thank you", "Thanks for using AJART Printer! Was your print worth supporting me for 5$?")
        if result == "yes":
